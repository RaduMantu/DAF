...
static struct argp_option options[] = {
    ...
    { "proto",    'p',      "{NUM|tcp|udp}",  0, "[!] Layer 4 protocol number",    0 },
    { "sport",    ARG_SRCP, "PORT",           0, "[!] Source port",               10 },
    { "dport",    ARG_DSTP, "PORT",           0, "[!] Destination port",          10 },
    { "sng-hash", ARG_SNGH, "HEXSTR",         0, "[!] Hash of single object",     20 },
    { "agg-hash", ARG_AGGH, "HEXSTR",         0, "[!] Aggregate multiple hashes", 20 },
    { "vrdct",    'v',      "{ACCEPT|DROP}",  0, "Verdict for matched criteria",  30 },
    { "chain",    'c',      "{INPUT|OUTPUT}", 0, "Where to apply command",        30 },
